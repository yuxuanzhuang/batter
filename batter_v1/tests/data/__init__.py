...
pipeline_sim_json = (pipeline_input_files / 'simulation_input.json')
pipeline_sim_extra_rest_json = (pipeline_input_files / 'simulation_input_extra_rest.json')
pipeline_sim_dist_rest_json = (pipeline_input_files / 'simulation_input_dist_rest.json')
