"""
This script is used to run the RBFE pipeline.

The RBFE pipeline is used to calculate the absolute binding free energy of ligand to a protein
in a lipid bilayer.
...
input_file = 'data/input_files/rbfe.in'
overwrite = False
