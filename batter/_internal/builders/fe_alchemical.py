...
from .fe_registry import BUILD_COMPLEX_REGISTRY, RESTRAINT_REGISTRY, SIM_FILES_REGISTRY
...
class AlchemicalFEBuilder(BaseBuilder):
    ...
    def _build_complex(self) -> bool:
        ...
        return BUILD_COMPLEX_REGISTRY[comp](self)
    ...
    def _run_files(self) -> None:
        num_sim = int(self.sim_config.num_fe_range)
        lambdas = self.component_windows_dict[self.comp]
        run_files.write_fe_run_file(self.ctx, num_sim, lambdas)