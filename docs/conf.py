...
project = "batter"
copyright = (
    "2024, Yuxuan Zhuang. Project structure based on the "
...
latex_documents = [
    (master_doc, "batter.tex", "batter Documentation", "batter", "manual"),
]
...
man_pages = [(master_doc, "batter", "batter Documentation", [author], 1)]
