...
set filini equil-g1i-ini.pdb
set filpdb equil-g1i.pdb
set n 0
set rad 100
set xd -0.24 
set yd -5.88 
...
set pr [atomselect 0 "(not resname 'g1i') and (resid 1 to 284 and name CA C N O)"]
set all [atomselect 0 "(resid 1 to 284 and not water and not resname 'g1i' and noh) or (resname 'g1i') or (resname  WAT) or (resname PC PA OL) or (resname 'Na+' 'Cl-' 'K+')"]
...
set lig [atomselect 1 "resname 'g1i'"]
set ligh [atomselect 1 "resname 'g1i' and noh"]
$lig set chain S
$lig set resid 1
$lig writepdb g1i.pdb
$ligh writepdb g1i-noh.pdb

set a [atomselect 1 "resname 'g1i' and noh"]
set tot [$a get name]

foreach i $tot {
set t [atomselect 1 "resname 'g1i' and name $i"]
set p [atomselect 1 "(not resname 'g1i') and (resid 92 and name CA)"]
...
set angle {}
set t [atomselect 1 "resname 'g1i' and name $i"]
set p [atomselect 1 "resname 'g1i' and name $aa1"]
set d [atomselect 1 "(not resname 'g1i') and (resid 92 and name CA)"]
...
set angle {}
set t [atomselect 1 "resname 'g1i' and name $i"]
set p [atomselect 1 "resname 'g1i' and name $aa2"]
set d [atomselect 1 "resname 'g1i' and name $aa1"]
...
set a [atomselect 1 "(not resname 'g1i') and (resid 1 to 284 and name CA C N O)"]
set b [atomselect 1 "resname 'g1i' and noh"]
...
set e [atomselect 1 "name CA and same residue as ((resid 1 to 284) and within 6 of resname 'g1i')"]
