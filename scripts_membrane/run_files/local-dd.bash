...
# Minimization steps
pmemd.cuda -O -i mini.in -p $PRMTOP -c $INPCRD -o md-min.out -r md-min.rst7 -ref $INPCRD
echo "Minimization complete."

# Heating steps
pmemd.cuda -O -i heat.in -p $PRMTOP -c md-min.rst7 -o md-heat.out -r md-heat.rst7 -x md-heat.nc -ref $INPCRD
echo "Heating complete."

# Equilibration with protein restrained
pmemd.cuda -O -i eqnpt0.in -p $PRMTOP -c md-heat.rst7 -o eqnpt_pre.out -r eqnpt_pre.rst7 -x traj_pre.nc -ref $INPCRD
