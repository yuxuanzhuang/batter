"""Helpers for selecting and generating execution run identifiers."""
...
def select_run_id(
    ...
    -------
    (run_id, run_dir)
        The resolved run identifier and the directory backing it.
    """
...
def generate_run_id(protocol: str, system_name: str) -> str:
    """Construct a timestamped identifier for storing execution artifacts."""
